          ...
          <v-list-item-subtitle>
            <v-container :fluid="true">
              <v-row class="align-center">
                ...
                <create-comment-form :comment="comment" :post="comment.post" />
              </v-row>
              <v-row class="ml-12">
                <reply-element v-for="(reply, index) in comment.replies" :key="index" :comment="reply" />
              </v-row>
            </v-container>
          </v-list-item-subtitle>
        </v-list-item-content>
...
import ReplyElement from '@/components/Comments/ReplyElement'
import CreateCommentForm from '@/components/Comments/CreateCommentForm'

export default {
  name: 'CommentElement',
  components: { CreateCommentForm, ReplyElement },
  props: {
    comment: {
      type: Object,
      default: null
